module.exports = function(app,model){
    ...
    app.get("/api/allTopic", findAllTopics);
    ...
    app.post("/api/user/:userId/topic", createTopic);
    ...
    app.get("/api/user/:userId/topic",findTopicsByUser);
    ...
    app.get("/api/topic/:topicId",findTopicById);
    ...
    app.put("/api/topic/:topicId", updateTopic);
    ...
    app.delete("/api/topic/:topicId",deleteTopic);
