module.exports = function (app,model){
    ...
    app.post("/api/project/topic/:topicId/gif", createGif);
    ...
    app.get("/api/project/topic/:topicId/gif",findGifByTopicId);
    ...
    app.get("/api/project/gif/:gifId",findGifById);
    ...
    app.put("/api/project/gif/:gifId",updateGif);
    ...
    app.delete("/api/project/gif/:gifId", deleteGif);
